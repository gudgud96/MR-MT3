...
# Slakh
# ====== version 1 ====== #
# exp_tag_name = "commu_v1"
# dir = sorted(glob.glob(f"{exp_tag_name}/*.mid"))
# dir2 = [k.replace(f"{exp_tag_name}/", "/data/datasets/ComMU/dataset/commu_midi_v2/test/raw/").replace("_16k.mid", ".mid") for k in dir]
# fnames = zip(dir2, dir)

# ====== version 2 ====== #
exp_tag_name = "commu_v4"
dir = sorted(glob.glob(f"{exp_tag_name}/*.mid"))
dir2 = [k.replace(f"{exp_tag_name}/", "/data/datasets/ComMU/dataset_processed/commu_midi_v2/test/").replace("_16k.mid", ".mid") for k in dir]
fnames = zip(dir2, dir)
