...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def __init__(
        ...
        # print('segmem_num_layers', segmem_num_layers)
    ...
    def get_model_outputs(
        ...
        # print('decoder_input_ids', decoder_input_ids[0][:500])
        ...
        lm_tokens = torch.argmax(lm_logits, dim=-1)
