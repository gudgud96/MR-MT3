...
from dataset.dataset_commu import ComMUDataset, collate_fn
...
def main(config, model_config, result_dir, mode, path):
    ...
    if mode == "train":
        ...
        trainer.fit(
            model, 
            # ckpt_path="logs/results_commu_20231020_111621/version_0/checkpoints/last.ckpt"
            # ckpt_path="logs/results_commu_20231020_154040/version_0/checkpoints/last.ckpt"
        )
...
if __name__ == "__main__":
    ...
    conf_file = 'config/config_commu.yaml'
    ...
    if args.mode == "train":
        ...
        result_dir = f"logs/results_commu_{datetime_str}"
