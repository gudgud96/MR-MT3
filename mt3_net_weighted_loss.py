...
from models.t5_weighted_loss import T5ForConditionalGeneration
import torch.nn as nn
from utils import get_cosine_schedule_with_warmup, get_result_dir, get_mt3_optimizer
import torch
import json
...
def main(config, model_config, result_dir, mode, path):
    ...
    if mode == "train":
        ...
        trainer.fit(
            model, 
            ckpt_path="logs/results_norm_randomorder_wl_row=12|ep=800|lr=2e-4|warmup=64500_20231030_235313/version_0/checkpoints/last.ckpt"
            # ckpt_path="logs/results_norm_randomorder_20231005_164759/version_0/checkpoints/last.ckpt"
            # ckpt_path="logs/results_norm_randomorder_20231022_013534/version_0/checkpoints/last.ckpt"
        )
...
if __name__ == "__main__":
    ...
    if args.mode == "train":
        ...
        result_dir = f"logs/results_norm_randomorder_wl_row=12|ep=800|lr=2e-4|warmup=64500_{datetime_str}"
